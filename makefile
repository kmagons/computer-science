...
runner: runner.o TestList.o TestQueue.o TestMinPriorityQueue.o TestGraph.o Graph.o
	g++ -o runner runner.o TestList.o TestQueue.o TestMinPriorityQueue.o TestGraph.o Graph.o   -L${CPPUNIT_PATH}/lib -lstdc++ -lcppunit -ldl
