...
runner: runner.o TestList.o TestQueue.o TestMinPriorityQueue.o
	g++ -o runner runner.o TestList.o TestQueue.o TestMinPriorityQueue.o  -L${CPPUNIT_PATH}/lib -lstdc++ -lcppunit -ldl
