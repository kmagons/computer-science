...
runner: runner.o TestList.o TestQueue.o TestMinPriorityQueue.o TestGraph.o TestStack.o Graph.o Agent.o TestAgent.o
	g++ -o runner runner.o TestList.o TestQueue.o TestMinPriorityQueue.o TestGraph.o TestStack.o Graph.o TestAgent.o   -L${CPPUNIT_PATH}/lib -lstdc++ -lcppunit -ldl
